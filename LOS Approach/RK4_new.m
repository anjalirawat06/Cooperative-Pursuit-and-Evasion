function [p, g, l, l_dot, r, r_dot, aa_new, ad_new, am_new, S, phi, phi_dot] = RK4_new(p, g, l, l_dot, r, r_dot, a_aa, h, c, M, S, V)
    ...
    ad = -(2*r_dot(2) - c*r(2))*l_dot(2)/cos(g(2) - l(2))  +  (r(2)/r(1))*(2*r_dot(1) - c*r(1))*l_dot(1)/cos(g(2)-l(2))  +  (r(2)/r(1))*cos(g(1) - l(1))*a_aa/cos(g(2)-l(2))  -  M*sign(S)/cos(g(2)-l(2)); 
    ...
    a(2) = -(2*r_dot(2) - c*r(2))*l_dot(2)/cos(g_b(2) - l(2))  +  (r(2)/r(1))*(2*r_dot(1) - c*r(1))*l_dot(1)/cos(g_b(2)-l(2))  +  (r(2)/r(1))*cos(g_b(1) - l(1))*a_aa/cos(g_b(2)-l(2))  -  M*sign(S)/cos(g_b(2)-l(2)) ; 
    ...
    a(1) = a_aa;
    a(3) = -3*l_dot(1)*r_dot(1);
    a(2) = -(2*r_dot(2) - c*r(2))*l_dot(2)/cos(g_c(2) - l(2))  +  (r(2)/r(1))*(2*r_dot(1) - c*r(1))*l_dot(1)/cos(g_c(2)-l(2))  +  (r(2)/r(1))*cos(g_c(1) - l(1))*a_aa/cos(g_c(2)-l(2))  -  M*sign(S)/cos(g_c(2)-l(2)); 
    ...
    a(1) = a_aa;
    a(3) = -3*l_dot(1)*r_dot(1);
    a(2) = -(2*r_dot(2) - c*r(2))*l_dot(2)/cos(g_d(2) - l(2))  +  (r(2)/r(1))*(2*r_dot(1) - c*r(1))*l_dot(1)/cos(g_d(2)-l(2))  +  (r(2)/r(1))*cos(g_d(1) - l(1))*a_aa/cos(g_d(2)-l(2))  -  M*sign(S)/cos(g_d(2)-l(2)) ; 
    ...
    ad_new = -(2*r_dot(2) - c*r(2))*l_dot(2)/cos(g_d(2) - l(2))  +  (r(2)/r(1))*(2*r_dot(1) - c*r(1))*l_dot(1)/cos(g_d(2)-l(2))  +  (r(2)/r(1))*cos(g_d(1) - l(1))*a_aa/cos(g_d(2)-l(2))  -  M*sign(S)/cos(g_d(2)-l(2)) ; 
